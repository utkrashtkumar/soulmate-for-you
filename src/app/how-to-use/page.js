...
export default function HowToUsePage() {
  ...
  const steps = [
    ...
    },
    {
      ...
      descEn: 'Interact using Virtual Gifts, 3D Love Tarot, Status Stories, Companion Secret Diary, Love Letters & Compatibility Quiz!',
      descHi: 'Virtual Gifts, 3D Love Tarot, Status Stories, Secret Diary, aur Compatibility Quiz se companion ke saath mazedaar time spend karein!',
      detailsEn: [
        ...
        '🎮 Compatibility Quiz & Truth or Dare Party Game',
      ],
      detailsHi: [
        ...
        '🎮 Compatibility Quiz aur Truth or Dare game',
      ],
